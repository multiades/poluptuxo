// Wait until all HTML elements are fully parsed, is not necessary if the script is at the end of the html's body but it does not add overhead
// and it future-proofs the script.
document.addEventListener('DOMContentLoaded', () => { 
  const toggler = document.getElementById('navbar_toggle'); // The navbar's toggle hidden checkbox
  ...
  function navInteractivity () { 
    ...
    navbar.querySelectorAll('a, label.dropdown').forEach(focusable => {
